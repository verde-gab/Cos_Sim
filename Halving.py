...
resultado_atingidos = pd.DataFrame(resultados)
# checando se a variavel resultado_atingidos estiver vazio
if not resultado_atingidos.empty:
    resultado_atingidos = resultado_atingidos.pivot(index = 'Halving', columns = 'Data', values = 'Similaridade do Coseno')
    print(resultado_atingidos)